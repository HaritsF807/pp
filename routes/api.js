...
var creatorList = ['Harits Fahrizal','Harits'];
...
loghandler = {
    notparam: {
        ...
        getApikey: 'gak punya apikey? chat gw aja yaaa di wa.me/62895422801347 , key nya gratis kok gan, jadi santuyy ajaa'
    },
    notkey: {
        status: false,
        creator: `${creator}`,
    ...
    invalidKey: {
        ...
        creator: `${creator}`,
        code: 406,
        message: 'apikey invalid, gak punya apikey? chat gw aja yaaa di wa.me/62895422801347 , key nya gratis kok gan, jadi santuyy ajaa'
    },
    invalidlink: {
        status: false,
        creator: `${creator}`,
...
var len = 15
        ...
        var randomTextNumber = random+randomlagi+'---------HaritsF'+'HaritsGans';
...
router.get('/find', async (req, res, next) => {
    ...
    if (apikey != 'HaritsF') return res.json(loghandler.invalidKey)
...
router.get('/cekapikey', async (req, res, next) => {
	...
	json = JSON.stringify({
		...
		message: `jangan lupa follow @harits_fahrizal`
	})
} else {
	json = JSON.stringify({
		status: false
...
router.get('/tiktod', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)
	if(apikeyInput != HaritsF') return res.json(loghandler.invalidKey)
